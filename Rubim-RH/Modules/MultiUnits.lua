...
function RubimRH.UpdateSplashCount(UpdateUnit, SplashRange)
...
function RubimRH.GetSplashCount(UpdateUnit, SplashRange)
...
function RubimRH.ValidateSplashCache()
  for _, Ability in pairs(RT.NucleusAbilities) do
