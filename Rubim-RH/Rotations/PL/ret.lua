...
local function Finishers()
    ...
    if (S.Inquisition:IsAvailable() and S.Inquisition:IsReady()) and (not Player:Buff(S.Inquisition)
            ...
            or S.ExecutionSentence:IsAvailable() and S.ExecutionSentence:CooldownRemains() < 10 and Player.BuffRemains(S.Inquisition) < 15 or S.AvengingWrath:CooldownRemains() < 15 and S.Inquisition:BuffRemains() < 20 and Player:HolyPower() >= 3) then
