...
local function APL()
    ...
    if RubimRH.CDsON() and RubimRH.RacialON() and S.ArcaneTorrent:IsReady() and (Player:RunicPowerDeficit() > 65 and (Player:GargoyleActive() or not S.SummonGargoyle:IsAvailable()) and Player:RunicPowerDeficit() >= 5) then
