...
local function APL()
 ...
 --   end
  ...
  Spenders = function()
    ...
    if S.SeedofCorruption:IsCastableP() and Player:SoulShardsP() >= 1 and (not Player:IsMoving()) and not Player:ShouldStopCasting() and (bool(VarUseSeed)) then
      return S.SeedofCorruption:Cast()
    end
  ...
  if RubimRH.TargetIsValid() then
    ...
    if S.SeedofCorruption:IsCastableP() and (not Player:IsMoving()) and not Player:ShouldStopCasting() and (bool(VarUseSeed) and Player:SoulShardsP() == 5) then
      return S.SeedofCorruption:Cast()
    end
