...
local function Bear()
	...
	-- Barkskin
	if S.Barkskin:IsReady()	and not Player:BuffP(S.SurvivalInstincts) and not Player:BuffP(S.Barkskin) and Player:HealthPercentage() <= RubimRH.db.profile[104].sk1 then
