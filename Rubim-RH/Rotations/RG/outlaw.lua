...
local function Build ()
    ...
    if S.PistolShot:IsReady(20) and Player:BuffP(S.Opportunity) and (Player:BuffStackP(S.KeepYourWitsBuff) < 25 or Player:BuffP(S.DeadshotBuff) or Player:Energy() < 45) then
